    ...
    <div
                    ...
                    <div>
                        ...
                        <div class="mt-8 flex items-center justify-between space-x-2">
                            <div class="flex -space-x-3">
                                ...
                                <div class="avatar size-8 hover:z-10">
                                    <img class="rounded-full ring ring-white dark:ring-navy-700"
                                        src="images/avatar/avatar-14.jpg" alt="avatar">
                                </div>
                            </div>
                            <button
                                class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    ...
                    <div>
                        ...
                        <div class="mt-8 flex items-center justify-between space-x-2">
                            <div class="flex -space-x-3">
                                ...
                                <div class="avatar size-8 hover:z-10">
                                    <img class="rounded-full ring ring-white dark:ring-navy-700"
                                        src="images/avatar/avatar-10.jpg" alt="avatar">
                                </div>
                            </div>
                            <button
                                class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
        ...
        <div class="col-span-12 lg:col-span-4">
            ...
            <div class="mt-4 flex h-2 space-x-1">
                <div class="w-5/12 rounded-full bg-primary dark:bg-accent" x-tooltip.primary="'Exellent'">
                </div>
    ...
    <div class="mt-4 grid grid-cols-12 gap-4 bg-slate-150 py-5 dark:bg-navy-800 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
        ...
        <div
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                    ...
                    <div class="mt-2 flex flex-wrap">
                        ...
                        <div class="mr-4 mb-1 inline-flex items-center space-x-2 font-inter">
                            ...
                            <div class="flex space-x-1 text-xs">
                                <span class="font-medium text-slate-700 dark:text-navy-100">Chat
                                    Messages</span>
                                <span>17%</span>
                            </div>
                        </div>
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 1'" class="size-6" src="images/awards/award-19.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="images/awards/award-2.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-5.svg"
                            alt="avatar">
                    </div>
                    <button
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 1'" class="size-6" src="images/awards/award-1.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="images/awards/award-6.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-9.svg"
                            alt="avatar">
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="images/awards/award-14.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-13.svg"
                            alt="avatar">
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="images/awards/award-15.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-13.svg"
                            alt="avatar">
                    </div>
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        ...
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-5.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-25.svg"
                            alt="avatar">
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                ...
                <div class="flex justify-between">
                    <div class="flex space-x-2">
                        <img x-tooltip="'Award Level 2'" class="size-6" src="images/awards/award-1.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-24.svg"
                            alt="avatar">
                        <img x-tooltip="'Award Level 3'" class="size-6" src="images/awards/award-30.svg"
                            alt="avatar">
                    </div>
                    <button
                        class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
