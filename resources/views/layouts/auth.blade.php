        ...
        <div class="hidden w-full place-items-center lg:grid">
            <div class="w-full max-w-lg p-6">
                <img class="w-full" x-show="!$store.global.isDarkModeEnabled"
                    src="Admin/images/illustrations/dashboard-check.svg" alt="image">
                <img class="w-full" x-show="$store.global.isDarkModeEnabled"
                    src="Admin/images/illustrations/dashboard-check-dark.svg" alt="image">
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('login.post') }}" class="mt-6">
                    ...
                    <div class="mb-4">
                        <label class="relative flex">
                            <input name="identity" value="{{ old('identity') }}"
                                class="form-input peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                                placeholder="Usuario o Email" type="text" autocomplete="username" required autofocus>
                            <span
                    ...
                    <div class="mb-4 py-2">
                        <label class="relative flex">
                            <input name="password"
                                class="form-input peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                                placeholder="Contraseña" type="password" autocomplete="current-password" required>
                            <span
                                class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 transition-colors duration-200"
                                    fill="none" viewbox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mt-4 flex items-center justify-between space-x-2">
                        <label class="inline-flex items-center space-x-2">
                            ...
                            <span class="line-clamp-1">Recordar sesión</span>
                        </label>
                        <a href="#"
