        ...
        <section class="error">
            ...
            <div class="error__content">
                <div class="error__message message">
                    ...
                    <p class="message__text">Lo sentimos, la pagina que esta buscando no se encuentra. Esta seguro que existe el enlace.
                        Si el problema persiste contacte con un administrador.</p>
                </div>
                <div class="error__nav e-nav">
                    <a href="http://sysinvec.cu" target="_blanck" class="e-nav__link"></a>
                </div>
            </div>
            <!-- END Content -->
